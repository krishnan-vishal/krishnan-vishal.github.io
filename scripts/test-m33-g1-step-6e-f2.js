...
assert.match(source, /const CONTROLLED_SOURCE_IDS = \[TEST_SOURCE_ID, RBI_SOURCE_ID, FINTECH_FUTURES_SOURCE_ID\]/);
...
console.log("M33-G1 Step 6E source authorization: PASS (SFA/RBI/Fintech Futures only; unknown blocked)");
