...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| SUPABASE-ANNOUNCEMENTS-04 | 2026-09-14 | Add standalone HTML/RSS scraper for Supabase announcements | AUTOMATION, DATA, PUBLICATION CONTROL | High | IN PROGRESS | Verified project-owner publication approval/review and live workflow/database verification | Stage 1 | `scraper.js`, `.github/workflows/run-ticker.yml` | Read C/A sources and write duplicate-safe announcement rows with current UTC `MM/YYYY` archive value. User subsequently requested approved/ticker-eligible status for new and matching existing URLs. | Focused insert/promotion contract and announcement regressions pass; live insert and consumer display verified. | Status/eligibility change validated and pushed on feature branch; auto-review rejected direct main push as unverified publication-control authorization. Live database result and public-site display unverified. | PENDING | Work branch | SUPABASE-ANNOUNCEMENTS-04 |
