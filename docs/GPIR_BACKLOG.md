...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| SUPABASE-ANNOUNCEMENTS-04 | 2026-09-14 | Add standalone HTML/RSS scraper for Supabase announcements | AUTOMATION, DATA, PUBLICATION CONTROL | High | IN PROGRESS | Owner review and live workflow/database verification | Stage 1 | `scraper.js`, `.github/workflows/run-ticker.yml` | Read C/A sources and write duplicate-safe announcement rows with current UTC `MM/YYYY` archive value. Owner subsequently directed approved/ticker-eligible status for new and matching existing URLs. | Focused insert/promotion contract and announcement regressions pass; live insert and consumer display verified. | Owner-directed status/eligibility change implemented locally; live database result and public-site display unverified. Static canonical reader remains separate. | PENDING | Work branch | SUPABASE-ANNOUNCEMENTS-04 |
