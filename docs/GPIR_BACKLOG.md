...
## M34-A authentication and subscriber access
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| M34-A-GATE-1 | 2026-09-18 | Design authentication and registered-reader access without production change | ARCHITECTURE, SECURITY, GOVERNANCE, READER EXPERIENCE | High | COMPLETED | Owner review before Gate 2 | M34-A Gate 1 | `docs/M34-A-GATE-1-AUTHENTICATION-ARCHITECTURE.md` | Inspect approved main and define routes, redirects, roles, entitlements, consent/privacy/audit schema, RLS, TOTP/AAL2, exact-UUID owner bootstrap, optional encrypted phone, Turnstile points, delayed invitation, protected-content boundary, tests and rollback. | Complete Gate 1 report; no implementation/runtime/production/M33 change; all unresolved activation risks and owner-only actions explicit. | Architecture/manifests complete; content/link/announcement/intent/pipeline/secret/whitespace checks pass; four pre-existing performance advisories remain. Gate 2 is separately approvable for isolated feature-flagged implementation only; public activation remains prohibited. | 2026-09-18 | Branch commit subject `M34-A Gate 1 define authentication architecture` | M34-A |
| M34-A-GATE-2 | 2026-09-18 | Implement and isolate the approved authentication foundation | ARCHITECTURE, SECURITY, READER EXPERIENCE | High | PARKED | Explicit owner approval of Gate 1; isolated Supabase test environment; confirmed owner UUID; accepted session/header strategy | M34-A Gate 2 | Proposed auth routes, M34 migrations/functions and deterministic tests | Build only the owner-approved subset behind inactive flags; no production application or public registration. | Isolated migration/RLS/AAL2, route, protected-artifact, privacy, accessibility and rollback proofs pass. | Not started. No Gate 2 file, migration, function or runtime action exists. | PENDING | PENDING | M34-A |
