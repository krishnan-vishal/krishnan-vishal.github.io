...
| FX-BIDIRECTIONAL-03 | 2026-09-14 | Support both sending directions in public FX archive and Treasury cards | READER EXPERIENCE, DATA | High | IN PROGRESS | Owner-controlled publication and publicly readable archive rows | Stage 1 | `assets/js/fx-public-history.js`, `assets/js/fx-app.js`, `pages/fx/historical.html`, `pages/fx/weekly.html` | Derive missing inverse pairs without replacing recorded reverse observations; display six-decimal inverse rates and mathematically inverted movement. | JPY/USD, GBP/EUR and all 28 regional targets resolve; arrows and colors match inverse movement; validations pass. | Implemented and locally validated; live Supabase data and publication pending. | PENDING | Work branch | FX-BIDIRECTIONAL-03 |
