...
- Validation/remote state: local validation recorded in the M29 PR handoff; commit, push, PR, Actions and owner merge are pending at this checkpoint. No production merge is authorised.
