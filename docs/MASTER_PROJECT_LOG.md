...
- Remote state: implementation and validation are committed through `82e9962`; `work/m29-global-source-network-activation` is pushed and PR #349 is open against `main`. Actions, owner review and owner merge remain pending. No production merge is authorised.
