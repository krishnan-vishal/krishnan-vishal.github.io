...
- Remote state: the implementation commit exists locally; a final checkpoint commit, push, remote-SHA confirmation, one PR, Actions and owner merge remain pending. No production merge is authorised.
